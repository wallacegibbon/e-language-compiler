...
-spec init_jump_pos(option()) -> {ok, non_neg_integer()} | none.
init_jump_pos(#{init_jump_exist := false}) ->
	none;
...
-spec code_start_pos(option()) -> non_neg_integer().
