...
root_stmts root_stmt struct_def function_def var_defs var_def
params function_stmts function_stmt if_stmt else_stmt while_stmt goto_label
expr call_expr pre_minus_plus_expr sizeof_expr assign_expr
type_annotations type_anno op19 op30 op29 op28 op27 op26 op25 op2_with_assignment
pointer_depth atomic_literal_values array_init_expr array_init_elements
struct_init_expr struct_init_fields struct_init_assignment reserved_keyword
...
while_stmt -> while expr do function_stmts 'end' :
    #while_stmt{condi = '$2', stmts = '$4', line = token_line('$1')}.
...
expr -> sizeof_expr : '$1'.
expr -> '(' expr ')' : '$2'.
expr -> '(' expr as type_anno ')' :
    #type_convert{expr = '$2', type = '$4', line = token_line('$3')}.
