...
typeanno -> 'fun' '(' typeanno_list ')' :
    #fun_type{params = '$3', ret = ecompiler_util:void_type(tok_line('$4')),
              line = tok_line('$1')}.
typeanno -> 'fun' '(' ')' ':' typeanno :
    #fun_type{params = [], ret = '$5', line = tok_line('$1')}.
typeanno -> 'fun' '(' ')' :
    #fun_type{params = [], ret = ecompiler_util:void_type(tok_line('$3')),
              line = tok_line('$1')}.
...
typeanno -> any_type pointer_depth :
    #basic_type{class = any, pdepth = '$2', tag = void,
                line = tok_line('$1')}.
typeanno -> any_type :
...
defvar -> identifier ':' typeanno '=' expr :
    #vardef{name = tok_val('$1'), type = '$3', initval = '$5',
            line = tok_line('$1')}.
...
defun -> 'fun' identifier '(' defvars ')' ':' typeanno exprs 'end' :
    #function_raw{name = tok_val('$2'), params = '$4', ret = '$7',
                  exprs = '$8', line = tok_line('$2')}.
defun -> 'fun' identifier '(' ')' ':' typeanno exprs 'end' :
    #function_raw{name = tok_val('$2'), params = [], ret = '$6',
                  exprs = '$7', line = tok_line('$2')}.
defun -> 'fun' identifier '(' defvars ')' exprs 'end' :
    #function_raw{name = tok_val('$2'), params = '$4',
                  ret = ecompiler_util:void_type(tok_line('$5')),
                  exprs = '$6', line = tok_line('$2')}.
defun -> 'fun' identifier '(' ')' exprs 'end' :
    #function_raw{name = tok_val('$2'), params = [],
                  ret = ecompiler_util:void_type(tok_line('$4')),
