...
-record(e_op, {line = 0 :: integer(), tag :: e_op_tag(), data = [] :: [e_expr()]}).
...
-record(e_struct, {line = 0 :: integer(), name :: atom(), size = -1 :: integer(), align = -1 :: integer(), field_type_map :: e_var_type_map(), field_offset_map = #{} :: #{atom() := integer()}, field_names = [] :: [#e_varref{}], field_default_value_map = #{} :: #{atom() := e_expr()}}).
-record(e_function, {line = 0 :: integer(), name :: atom(), type :: #e_fn_type{}, param_names = [] :: [atom()], var_type_map :: e_var_type_map(), var_offset_map = #{} :: e_var_offset_map(), labels = [] :: [#e_goto_label{}], stmts = [] :: [e_stmt()]}).
...
-type e_var_offset_map() :: #{atom() := integer()}.
