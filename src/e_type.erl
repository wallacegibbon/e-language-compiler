...
check_types_in_ast([#function{var_type_map = VarTypes, stmts = Exprs, type = FnType} | Rest], GlobalVarTypes, {FnTypeMap, StructMap} = Maps) ->
...
check_types_in_ast([#struct{name = Name, field_type_map = FieldTypes, field_names = FieldNames, field_default_value_map = FieldDefaults} | Rest], GlobalVarTypes, {FnTypeMap, StructMap} = Maps) ->
