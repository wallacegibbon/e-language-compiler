...
function_normal_test() ->
    ...
    %?debugFmt("~p~n", [Tokens]),
    ?assertEqual([{'fun', 1}, {identifier, 1, a}, {'(', 1}, {identifier, 1, v}, {':', 1}, {int_type, 1, i8}, {'^', 1}, {')', 1},
...
function_pointer_test() ->
    ...
    ?assertEqual([{identifier, 1, a}, {':', 1}, {'fun', 1}, {'(', 1}, {int_type, 1, u8}, {',', 1}, {int_type, 1, u8},
                  {'^', 1}, {')', 1}, {':', 1}, {int_type, 1, u16}, {'^', 1}, {'=', 1}, {identifier, 1, b}, {';', 1}], Tokens),
    {ok, AST} = e_parser:parse(Tokens),
    %?debugFmt("~p~n", [AST]),
...
function_call_test() ->
    ...
    %?debugFmt("~p~n", [Tokens]),
    ?assertEqual([{identifier, 1, b}, {':', 1}, {int_type, 1, u8}, {'=', 1}, {identifier, 1, a}, {'(', 1}, {integer, 1, 13}, {')', 1}, {';', 1}],
                 Tokens),
    {ok, AST} = e_parser:parse(Tokens),
    %?debugFmt("~p~n", [AST]),
...
array_test() ->
    ...
    %?debugFmt("~p~n", [Tokens]),
    ?assertEqual([{identifier, 1, a}, {':', 1}, {'{', 1}, {int_type, 1, u8}, {',', 1}, {integer, 1, 100}, {'}', 1}, {';', 1}], Tokens),
    {ok, AST} = e_parser:parse(Tokens),
    %?debugFmt("~p~n", [AST]),
