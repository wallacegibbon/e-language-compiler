...
check_position(#op2_expr{operator = assign, operand2 = Op2}) when is_record(Op2, struct_init_expr); is_record(Op2, array_init_expr) ->
    ok;
...
expand_init_expr([#while_stmt{stmts = Exprs} = E | Rest], NewAST, StructMap) ->
    expand_init_expr(Rest, [E#while_stmt{stmts = expand_init_expr(Exprs, [], StructMap)} | NewAST], StructMap);
...
replace_init_ops(#op2_expr{operator = assign, operand1 = Op1, operand2 = #struct_init_expr{name = Name, line = Line, field_value_map = FieldValues}}, StructMap) ->
...
replace_init_ops(#op2_expr{operator = assign, operand1 = Op1, operand2 = #array_init_expr{elements = Elements, line = Line}}, StructMap) ->
